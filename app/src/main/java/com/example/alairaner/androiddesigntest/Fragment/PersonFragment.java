...
import com.example.alairaner.androiddesigntest.Activity.LoginActivity;
import com.example.alairaner.androiddesigntest.Activity.MainActivity;
import com.example.alairaner.androiddesigntest.Activity.ChangedpwdActivity;
import com.example.alairaner.androiddesigntest.Activity.MyOrderActivity;
import com.example.alairaner.androiddesigntest.R;
import com.example.alairaner.androiddesigntest.common.ImageLoaderManager;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.my_collect:  //我的收藏
                Toast.makeText(mainActivity, "开发中！！！！！", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.my_account: //修改密码
                if (!mainActivity.isLogin()) {
                    startActivityForResult(new Intent(mainActivity, ChangedpwdActivity.class), MY_ACCOUNT_AFTER);
                    return;
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            ...
            case MY_ACCOUNT_BEFORE://未登录时修改密码，修改密码后进行登录
                if (resultCode == Activity.RESULT_OK && data.getBooleanExtra("logined", false)) {
                    Intent intent = new Intent(mainActivity, ChangedpwdActivity.class);
